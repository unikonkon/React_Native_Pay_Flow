...
export function TransactionGroupItem({ items, onItemPress, onItemLongPress }: TransactionGroupItemProps) {
        ...
        <View className="bg-background/40 border-t border-border">
          {items.map((t) => (
            <Pressable
              ...
              className="flex-row items-center py-2 pl-[60px] pr-4 border-b border-border/60"
            >
              <View className="flex-1">
